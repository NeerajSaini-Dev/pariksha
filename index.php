...
<div class="row">
<div class="col-lg-6">
<span class="logo">Pariksha</span></div>
...
<div class="form-group">
  ...
  <div class="col-md-12"> 
    <input  type="submit" class="sub" value="sign up" name="si " class="btn btn-primary"/>
  </div>
</div>
...
$c4=$_POST["password"];
  ...
  $query="INSERT INTO `user`(`name`, `gender`, `college`, `email`, `mob`, `password`) VALUES ('$name','$ge', '$c1','$c2','$c3','$c4')";
